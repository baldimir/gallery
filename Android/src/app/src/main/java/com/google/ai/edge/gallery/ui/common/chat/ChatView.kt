            ...
            ChatHistorySideSheetContent(
              ...
              onHistoryItemClicked = { sessionId ->
                ...
                if (session != null) {
                  Log.d(
                    TAG,
                    "Chat history: action=load_past_chat, capability_name=${task.id}, model_id=${selectedModel.name}, model_version=${selectedModel.version}",
                  )
              ...
              onNewChatClicked = {
                Log.d(
                  TAG,
                  "Chat history: action=click_new_chat, capability_name=${task.id}, model_id=${selectedModel.name}, model_version=${selectedModel.version}",
                )
          ...
          topBar = {
            ModelPageAppBar(
              ...
              onHistoryClicked = {
                Log.d(
                  TAG,
                  "Chat history: action=click_history_tab, capability_name=${task.id}, model_id=${selectedModel.name}, model_version=${selectedModel.version}",
                )
