  ...
  ChatView(
    ...
    onSendMessage = { model, messages ->
      ...
      if ((text.isNotEmpty() && chatMessageText != null) || audioMessages.isNotEmpty()) {
        ...
        Log.d(
          TAG,
          "Generate action: capability_name=${task.id}, active_skills=${activeSkills.joinToString(",")}, active_mcp_servers_count=$mcpCount, active_mcp_tools_count=$mcpToolsCount",
        )
      }
    },
